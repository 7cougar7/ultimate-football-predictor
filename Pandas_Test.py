...
def main():
    ...
    df = pd.read_csv('OffensiveRatings20' + year + '.csv', usecols=required_cols_off)
    df = df[1:]
    ...
    df_def = pd.read_csv('DefensiveRatings20' + year + '.csv', usecols=required_cols_def)
    df_def = df_def[1:]
    ...
    # The GOAT CODE
    df_total.to_csv('2019 Inputs.csv')
